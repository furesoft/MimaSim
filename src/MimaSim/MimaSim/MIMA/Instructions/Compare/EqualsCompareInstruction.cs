...
public class EqualsCompareInstruction : IInstruction, IDisassemblyInstruction
{
    ...
    {
        builder.AppendLine($"cmpeq {disassembler.FetchRegister()}, {disassembler.FetchRegister()}");
    }
}